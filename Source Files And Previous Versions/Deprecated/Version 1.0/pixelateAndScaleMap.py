...
def sendToOutFile(pwd, fileName, heightData, s_pillars, n_pillars):                                                                                                         # Writes the pillar height data to a .csv
    outFile = open(pwd + '/' + fileName + ' ' + s_pillars + '_' + n_pillars + '.csv', 'w')                                                                                  # Creates the empty .csv within the directory containing the original maps
...
def fromGUI(folder, footprint, n_pillars, s_pillars):                                                                                                                       # Function to communicate with GUI
    ...
    sendToOutFile(pwd=pwd, fileName=fileName, heightData=heightData, s_pillars=s_pillars, n_pillars=n_pillars)                                                              # Sends this information to a .csv file
